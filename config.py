...
OWNER_ID = int(getenv("OWNER_ID", 6395833427))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/vishalpandeynkp1/twinkle",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+Em45OOjxHa4zM2M1")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://envs.sh/WjQ.jpg"
)
PING_IMG_URL = getenv(
